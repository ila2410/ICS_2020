...
while type(duration) != int:
    ...
    try:
        ...
        duration = int(input("Set the duration of your timer!\n"))

    except:

        # This part of code will be executed when Python throw an exception
        # Print here, that user didn't type correct input
        print("The input you typed is not recognizable!\n")
...
while current_time < duration:
    ...
    print(duration, time_left, end="\r")

...
start_time = time.time() # Store start time using time.time() 
...
duration = ""   # Now initiate an empty string
...
while type(duration) != int:    # Put condition to while loop
    ...
    try:
        ...
        duration = int(input("Set time in seconds:\n"))
    
    except:
        print("Your input is incorrect. Try again.")    # This part of code will be executed when Python throw an exeption
